...
//
//     final profilePic = profilePicFromJson(jsonString);

import 'dart:convert';

ProfilePic profilePicFromJson(String str) => ProfilePic.fromJson(json.decode(str));

String profilePicToJson(ProfilePic data) => json.encode(data.toJson());
